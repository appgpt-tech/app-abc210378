...
const GamesTitle = () => {
  ...
  return <span>Games {record ? `"${record.gameName}"` : ''}</span>;
};
...
export const GamesList = () => (
  <List actions={<ListActions />} filters={ResourceFilters}>
    <DatagridConfigurable>
      ...
      <NumberField source="minimumBet" />
      <NumberField source="maximumBet" />
  ...
  <Edit title={<GamesTitle />}>
    <SimpleForm>
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 5 }}>
        ...
        <Grid item xs={4}>
          <NumberInput source="minimumBet" />
        </Grid>
        <Grid item xs={4}>
          <NumberInput source="maximumBet" />
        </Grid>
        <Grid item xs={4}>
